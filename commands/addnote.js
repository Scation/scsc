...
exports.run = (client, message, args) => {
    ...
    if (!args[0]) return message.channel.send("**/ Merci de donner des notes correcte s'il vous plaît. \**")
...
message.delete()
message.channel.send("**/ Vos notes ont bien été actualités avec succès. \**")
}
